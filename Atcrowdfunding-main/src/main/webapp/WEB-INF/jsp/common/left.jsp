        ...
        <ul style="padding-left:0px;" class="list-group">
            ...
            <li class="list-group-item tree-closed">
                ...
                <ul style="margin-top:10px;display:none;">
                    <li style="height:30px;">
                        &lt;%&ndash;<a href="${APP_PATH}/user/index.do"><i class="glyphicon glyphicon-user"></i> 用户维护</a>&ndash;%&gt;
            ...
            <c:forEach items="${sessionScope.permissionRoot.children}" var="permission">
                ...
                <c:if test="${not empty permission.children}">
                    <li class="list-group-item tree-closed">
                        <span><i class="${permission.icon}"></i>${permission.name} <span class="badge" style="float: right">${fn.length(perssion.children)}</span> </span>
                        <ul style="margin-top: 10px;display: none">
