                ...
                <div class="panel-body">
                    <form role="form" id="updateForm">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="floginacct" placeholder="${updateUser.loginacct}">
                        </div>
                        <div class="form-group">
                            <label for="fusername">用户名称</label>
                            <input type="text" class="form-control" id="fusername" placeholder="${updateUser.username}">
                        </div>
                        <div class="form-group">
                            <label for="femail">邮箱地址</label>
                            <input type="email" class="form-control" id="femail" placeholder="${updateUser.email}">
...
<script type="text/javascript">
    ...
    $("#updateBtn").click(function () {
        ...
        if (fusername.val().trim() == ""){
            layer.msg("用户名称不能为空，请重新输入！",{time:1000,icon:6,shift:6},function () {
                fusername.focus();//获取焦点
            });

            return false;
        }
        if (femail.val().trim() == ""){
            layer.msg("邮箱不能为空，请重新输入！",{time:1000,icon:6,shift:6},function () {
                femail.focus();//获取焦点
            });
        ...
        $.ajax({
            ...
            error:function () {
                layer.msg("修改用户失败",{time:1000,icon:5});
