...
<script type="text/javascript">
    ...
    function pageChange(pageno) {
        <%--window.location.href="${APP_PATH}/advert/index.do?pageno="+pageno;--%>
        queryPageAdvert(pageno);
    }
    var jsonObj={
            "pageno":1,
            "pagesize":20
            ...
            success:function (result) {
                ...
                if (result.success){
                    ...
                    $.each(data,function (i,n) {
                        ...
                        content+='<button type="button" onclick="window.location.href=\'${APP_PATH}/advert/update.htm?id='+n.id+'\'" class="btn btn-primary btn-xs"><i class=" glyphicon glyphicon-pencil"></i></button>';
    ...
    function deleteAdvert(id,loginacct) {
        layer.confirm("确定要删除用户"+loginacct+"吗",{icon:3,title:'提示'},function (cindex) {
            $.ajax({
                ...
                url:"${APP_PATH}/advert/deleteAdvert.do",
                beforeSend:function () {
                    return true;
    ...
    $("#deleteBatchBtn").click(function () {
        ...
        layer.confirm("确定要删除这些用户吗",{icon:3,title:'提示'},function (cindex) {
            $.ajax({
                ...
                url:"${APP_PATH}/advert/deleteBatch.do",
                beforeSend:function () {
